...
for value in  66 89 150 
do
    echo generating rt1_$value.out...
    ../hw4/randtrack 1 $value > rt_$value.out && sort -n rt_$value.out > rt_$value.outs && rm rt_$value.out && mv rt_$value.outs testcases_reference/rt1_$value.out 
    echo generating rt2_$value.out...
    ../hw4/randtrack 2 $value > rt_$value.out && sort -n rt_$value.out > rt_$value.outs && rm rt_$value.out && mv rt_$value.outs testcases_reference/rt2_$value.out 
    echo generating rt4_$value.out...
    ../hw4/randtrack 4 $value > rt_$value.out && sort -n rt_$value.out > rt_$value.outs && rm rt_$value.out && mv rt_$value.outs testcases_reference/rt4_$value.out 
done
...
# done
for value in  0 50 66 89 100 150 200 300 400 500
do
    echo generating rt1_$value.out...
